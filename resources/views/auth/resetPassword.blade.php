...
<html lang="en">
    ...
    <body>
        <div class="card3" width="900" height="300" style="background-color: #d7d7df" >
            <div class="row">
                <div class="column1" margin-left="100">
                    &nbsp;&nbsp;
                    <img src="{{ asset('/images/User/resetpassword.jpg') }}" id="profile" width="420" height="280" border-radius="4" readonly>
                </div>
                <div class="column2" margin-right="100"><br>
                    <h1 style="font-family: Arial">Password Reset</h1><br>
