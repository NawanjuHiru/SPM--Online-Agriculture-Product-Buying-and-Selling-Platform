<html>
  ...
  <body style="overflow-x:hidden">
    ...
    <img
      src="Home.png"
      alt="Home Image"
      style="float: right; width: 40%; height: 80%"
    />
    <h1>
    ...
    <span style="font-size: 20">
      ...
      cursus<br />
      sed nunc eget dictum Sed ornare cursus sed nunc eget dictumd nunc eget<br />
      dictum Sed ornare cursus sed nunc eget dictum
    </span>
    <br />
    <button class="button" style="float: left; margin-top: 20px">
    ...
    <div style="padding-left: 300px; padding-top: 80px">
      <h2>The Future of Agriculture <br />investments</h2>
      <span style="font-size: 20">
        Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed ornare
        cursussed nunc eget dictum Sed ornare cursus sed nunc eget dictumd nunc
        eget dictum Sed ornare cursus sed nunc eget dictum
      </span>
      <br />
    </div>
  </div>
  ...
  <!-- Footer -->
  <footer class="text-white" style="background-color: #6EBD6C; margin-top:50px; background-image: url('public/images/footer.png');">
    <!-- Grid container -->
    <div class="container p-4">
      <!--Grid row-->
      <div class="row" style>
        <!--Grid column-->
        <div class="align-left" style="margin-left: -300px">
          <h5 class="text-uppercase">Agri Online</h5>
        ...
        <!--Grid column-->
        <div class="float-end" style="margin-left: 900px; margin-top: -120px;">
        ...
        <!--Grid column-->
        <div class="" style="margin-left: -310px; margin-top: 0px;">
